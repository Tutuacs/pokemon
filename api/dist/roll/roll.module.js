...
exports.RollModule = RollModule = __decorate([
    (0, common_1.Module)({
        imports: [prisma_module_1.PrismaModule, auth_module_1.AuthModule, user_pokemon_module_1.UserPokemonModule],
        controllers: [roll_controller_1.RollController],
        providers: [roll_service_1.RollService, roll_function_service_1.RollFunctionService],
    })
], RollModule);
